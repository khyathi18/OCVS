...
<div class="demo_jui">
		<table cellpadding="0" cellspacing="0" border="0" class="display" id="log" class="jtable">
			...
			<tbody>
<?php 
$vice=mysqli_query($conn,"select * from candidate")or die(mysqli_error());
while($row=mysqli_fetch_array($vice)){ $id=$row['CandidateID']; ?>

<tr class="del<?php echo $id ?>">
	<td align="center" class="hide"><?php echo $row['abc']; ?></td>
	<td align="center"><?php echo $row['Party']; ?></td>
...
<input type="hidden" name="data_name" class="data_name<?php echo $id ?>" value="<?php echo $row['FullName']; ?>"/>
