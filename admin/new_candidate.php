...
<div class="navbar">
    ...
    <div class="controls">
    <input type="text" name="rfullname" class="rfullname">
    </div>
    </div>
    ...
    <div class="controls">
    <input type="text" name="rrollnumber" class="rrollnumber">
    </div>
    </div>
    ...
    <div class="controls">
    <input type="text" name="rusername" class="rusername">
    </div>
    </div>
   ...
   <select name="ryear" class="ryear" id="span2">
    ...
    <div class="controls">
    <input type="password" name="rpwd" class="rpwd">
    </div>
    </div>
